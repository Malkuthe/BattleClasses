...
public class BCMPacketHandler implements IPacketHandler {
	...
	public void onPacketData( INetworkManager manager, Packet250CustomPayload packet, Player player ){
		...
		if (packet.channel.equals(BCMInfo.CHANNEL)){
			...
			switch(packetType) {
				case PLAYER_CLASS: handleExtendedProperties(packet, player, inputStream); System.out.println("[DEBUG]CLASS PACKET"); break;
				case OPEN_SERVER_GUI: handleOpenServerGui(packet, (EntityPlayer) player, inputStream); System.out.println("[DEBUG]GUI PACKET"); break;
	...
	private void handleOpenServerGui( Packet250CustomPayload packet, EntityPlayer player, DataInputStream inputStream){
		...
		System.out.println("[DEBUG]OpenGui");
